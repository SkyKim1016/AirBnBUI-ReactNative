...
import { Text, Image, StyleSheet, View, FlatList, Dimensions, TouchableOpacity, TouchableWithoutFeedback } from 'react-native'
...
const parkingsSpots = [
  {
    ...
    coordinate: {
      latitude: 37.464454,
      longitude: 127.127039,
    },
    description: `This is Sky's home`,
    imgSrc: require('../../../../assets/SkyProfile.jpg')
  },
  {
    id: 2,
    title: 'Gyeongbokgung',
    ...
    coordinate: {
      latitude: 37.581086,
      longitude: 126.977206,
      
    },
    description: `Here is Gyeongbokgung where is most popular place of Korea`,
    imgSrc: require('../../../../assets/home-1.jpeg')
  },
  {
    id: 3,
    title: 'Namsan Tower',
    ...
    coordinate: {
      latitude: 37.551718,
      longitude: 126.988232
    },
    description: ``,
    imgSrc: require('../../../../assets/home-4.jpeg')
  },
  {
    id: 4,
    title: 'Sky Tower',
    ...
    coordinate: {
      latitude: 37.512938,
      longitude: 127.102664
    },
    description: ``,
    imgSrc: require('../../../../assets/home-2.jpeg')
  },
];
    ...
    return (
      <View style={styles.header}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          <Text style={styles.headerTitle}>Location app by HANEUL KIM</Text>
          {/* <Text style={styles.headerLocation}>Seoul, Republic of Korea</Text> */}
        </View>
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-end', marginTop:10 }}>
          ...
          <Image style={{flex: 1, width:100 , resizeMode: 'contain' }} source={require('../../../../assets/SkyProfile.jpg')}/>
        </View>
      </View>
    )
  }
      ...
      <View style={styles.container}>
        ...
        >
          {parkings.map(parking => (
            ...
            >
              <TouchableWithoutFeedback onPress={() => this.setState({ activeModal: item })} >
                <View style={ [
                  styles.marker,
                  styles.shadow,
                  this.state.active === parking.id ? styles.active : null
                ]}>
                  <Image source={parking.imgSrc} style={{width:70, height:70, resizeMode:"cover", borderRadius:80, marginTop:10}} />
                  <Text style={styles.markerStatus}>[ {parking.title} ] </Text>
...
const styles = StyleSheet.create({
  ...
  markerStatus: {width:130,height:25, color: '#5D5D5D', backgroundColor:"#FFFFFF", opacity:2, borderRadius:20,textAlign:"center" },
  shadow: {
